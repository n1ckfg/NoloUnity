...
public class NOLO_TestThrow : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (joint == null && device.GetNoloButtonDown(NoloVR_Controller.ButtonMask.Trigger))
        {
        ...
        else if (joint != null && device.GetNoloButtonUp(NoloVR_Controller.ButtonMask.Trigger))
        {
